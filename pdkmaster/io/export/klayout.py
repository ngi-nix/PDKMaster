...
class Generator:
    ...
    def _s_drc(self):
        ...
        return s + self._s_rules()

    def _s_lydrc(self):
        lydrc = ET.Element("klayout-macro")
        ET.SubElement(lydrc, "description")
        ET.SubElement(lydrc, "version")
        ET.SubElement(lydrc, "category").text = "drc"
        ET.SubElement(lydrc, "prolog")
        ET.SubElement(lydrc, "epilog")
        ET.SubElement(lydrc, "doc")
        ET.SubElement(lydrc, "autorun").text = "false"
        ET.SubElement(lydrc, "autorun-early").text = "false"
        ET.SubElement(lydrc, "shortcut")
        ET.SubElement(lydrc, "show-in-menu").text = "true"
        ET.SubElement(lydrc, "group-name").text = "drc_scripts"
        ET.SubElement(lydrc, "menu-path").text = "tools_menu.drc.end"
        ET.SubElement(lydrc, "interpreter").text = "dsl"
        ET.SubElement(lydrc, "dsl-interpreter-name").text = "drc-dsl-xml"
        s = dedent(f"""
            # Autogenerated file. Changes will be overwritten.
        ...
        """[1:]) + self._s_rules()
        ET.SubElement(lydrc, "text").text = s
